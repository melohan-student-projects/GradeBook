...
class LecturesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create lecture" do
    assert_difference("Lecture.count") do
      post lectures_url, params: { lecture: { category_id: @lecture.category_id, description: @lecture.description, name: @lecture.name } }
    end
  ...
  test "should update lecture" do
    patch lecture_url(@lecture), params: { lecture: { category_id: @lecture.category_id, description: @lecture.description, name: @lecture.name } }
