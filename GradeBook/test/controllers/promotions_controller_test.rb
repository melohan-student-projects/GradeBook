...
class PromotionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create promotion" do
    assert_difference("Promotion.count") do
      post promotions_url, params: { promotion: { end_date: @promotion.end_date, name: @promotion.name, start_date: @promotion.start_date, teacher_id: @promotion.teacher_id } }
    end
  ...
  test "should update promotion" do
    patch promotion_url(@promotion), params: { promotion: { end_date: @promotion.end_date, name: @promotion.name, start_date: @promotion.start_date, teacher_id: @promotion.teacher_id } }
